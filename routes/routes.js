...
import download_route from './download.route.js'
...
/** @desc: 
 * Route for POST login, POST register, GET auth 
 * */ 
router.use("/", auth_route);

/** @desc:
 * Route for GET user detail, GET user list, PATCH update 
 * */
...
router.use("/files", download_route);
